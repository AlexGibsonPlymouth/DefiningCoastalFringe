...
# 04d_LSOACentroidDistanceFrom_BGC_Coastline_61-80.R
...
# As set on lines 36-40, this script deals with buffers 61-80, which covers 10km to 0.5km

# Also see:
# 04a_LSOACentroidDistanceFrom_BGC_Coastline_1-20.R - covering 40km to 30.5km
